...
//#define DUAL_X_CARRIAGE
  ...
  #define X2_HOME_DIR    1       // Set to 1. The second X-carriage always homes to the maximum  position
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   180  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
...
//
// M43 - display pin status, toggle pins, watch pins, watch s & toggle LED, test servo probe
//
